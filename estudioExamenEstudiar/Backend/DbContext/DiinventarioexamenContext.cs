...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder
            ...
            .UseMySQL("server=127.0.0.1;port=3306;database=diinventarioexamen;user=root;password=Mario8751");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Articulo>(entity =>
        {
            ...
            entity.HasOne(d => d.DentrodeNavigation)
                .WithMany(p => p.InverseDentrodeNavigation)
            ...
            entity.HasOne(d => d.EspacioNavigation)
                .WithMany(p => p.Articulos)
            ...
            entity.HasOne(d => d.UsuarioaltaNavigation)
                .WithMany(p => p.ArticuloUsuarioaltaNavigations)
                .HasConstraintName("fk_usuarioalta_articulo");

            entity.HasOne(d => d.UsuariobajaNavigation)
                .WithMany(p => p.ArticuloUsuariobajaNavigations)
        ...
        modelBuilder.Entity<Permiso>(entity =>
        {
            ...
            entity.HasOne(d => d.PermisopadreNavigation)
                .WithMany(p => p.InversePermisopadreNavigation)
